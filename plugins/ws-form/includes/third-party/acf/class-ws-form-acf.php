<?php
	...
	class WS_Form_ACF {
		...
		// Get field meta key (We had to create this function because there is no easy way of updating repeaters / groups with ACF currently)
		...
		// Process ACF fields
		public static function acf_fields_to_list_fields($fields, $group_index = 0, $section_index = 0, $field_index = 1) {
				...
				switch($action_type) {
					...
					case 'group' :
						...
						if(isset($field['sub_fields'])) {
							...
							$acf_fields_to_list_fields_return = self::acf_fields_to_list_fields($field['sub_fields'], $group_index, $section_index + 1, 1);
			...
			return array('list_fields' => $list_fields);
		}
		...
		// Process ACF fields
		public static function acf_fields_to_meta_data($fields, $group_index = 0, $section_index = 0, $field_index = 1) {
				...
				switch($action_type) {
					...
					case 'group' :
						...
						if(isset($field['sub_fields'])) {
							...
							$acf_fields_to_meta_data_return = self::acf_fields_to_meta_data($field['sub_fields'], $group_index, $section_index + 1, 1);
			...
			return array('list_fields' => $list_fields, 'group_meta_data' => $group_meta_data, 'section_meta_data' => $section_meta_data);
		}
		...
		public static function acf_ws_form_field_value_to_acf_meta_value($meta_value, $acf_field_type, $field_id) {
			...
			if(empty($meta_value)) { return ''; } else { return $meta_value; }
		}
