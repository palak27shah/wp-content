	...
	class WS_Form_Data_Source_ACF extends WS_Form_Data_Source {
				...
				if($filter_by_post_id > 0) {
					...
					switch($acf_parent_field_type) {
						...
						default :
							...
							// Field that is now in a group or repeater
		...
		public function config_meta_keys($meta_keys = array(), $form_id = 0) {
			...
			foreach($acf_field_groups as $acf_field_group) {
				...
				WS_Form_ACF::acf_get_fields($options_acf, $acf_field_group_name, $acf_fields, true);
			}
			...
			$config_meta_keys = array(
				...
				'data_source_' . $this->id . '_filter_by_post' => array(
					...
					'type'						=>	'checkbox',
					'default'					=>	'',
					'help'						=>	__('Filter the options for this ACF by those selected in a post.'),
					'condition'					=>	array(
				...
				'data_source_' . $this->id . '_filter_by_post_id' => array(
					...
					'default'					=>	'',
					'placeholder'				=>	'#post_id',
					'help'						=>	__('Choose the post ID to filter by. This can be a number or WS Form variable. It defaults to the post ID the form is shown on.'),
					'condition'					=>	array(
